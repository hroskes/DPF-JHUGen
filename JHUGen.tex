...
\centering
\includegraphics[width=0.4\textwidth]{reweighting/validation/fa2halffa31} %\hfill
\includegraphics[width=0.4\textwidth]{reweighting/validation/fa2halffa3half}\\
\includegraphics[width=0.4\textwidth]{reweighting/validation/fa2Zgamma} %\hfill
...
\begin{columns}
\begin{column}{0.6\textwidth}
\includegraphics[width=.5\columnwidth]{reweighting/ATLASHVV/TO1}
\includegraphics[width=.5\columnwidth]{reweighting/ATLASHVV/TO2} \\
\includegraphics[width=.5\columnwidth]{reweighting/ATLASHVV/TO1plusTO2}
\includegraphics[width=.5\columnwidth]{reweighting/ATLASHVV/TO1minusTO2}
\end{column}
\begin{column}{0.4\textwidth}
\begin{itemize}
...
\begin{columns}
\begin{column}{0.6\textwidth}
\includegraphics[width=.5\columnwidth]{reweighting/HVV/WWmll}
\includegraphics[width=.5\columnwidth]{reweighting/HVV/WWmT} \\
\includegraphics[width=.5\columnwidth]{reweighting/HVV/WW1jetmll}
\includegraphics[width=.5\columnwidth]{reweighting/HVV/WW1jetmT}
\end{column}
\begin{column}{0.4\textwidth}
\begin{itemize}
